 ...
 * 
 * not a programming language,but a set of existing tech.
 * 
 ...
 * HOW IT WORKS?
 * 
 * A. uses XMLHttpRequest(xhr object) to achieve async opertaions
 * 
 * Vanilla JS = pure JS(no frameworks)
 * 
 * data can be transferred in many format other than http
 * 
